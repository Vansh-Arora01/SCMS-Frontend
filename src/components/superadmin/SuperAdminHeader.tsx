...
import { MailCheck, MailWarning, Users, Building2 } from "lucide-react";
import { useNavigate } from "react-router-dom";
import NotificationBell from "../shared/NotificationBell";

export default function SuperAdminHeader(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 md:gap-4 z-10 min-w-0">
        ...
        {/* Avatar */}
        <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold text-base md:text-lg shadow-lg shadow-indigo-500/30">
          {initials}
        </div>
