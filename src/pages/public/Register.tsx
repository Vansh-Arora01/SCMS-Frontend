...
// import { User, Mail, Lock, BadgeCheck, Building2, Loader2 } from "lucide-react";
...
//     if (!name || !email || !password || !college || !enrollment) return;
...
//       <div className="w-full max-w-3xl rounded-2xl bg-[#060612] p-8 shadow-2xl text-white">
...
//                 type="text"
//                 required
//                 className="w-full bg-transparent border-b border-gray-700 py-2 px-2 pr-8 outline-none focus:border-[#ff9a5a]"
//               />
//               <User className="absolute right-2 top-2 w-5 h-5 text-gray-500" />
//             </div>
//           </div>
...
//           {/* Enrollment */}
//           <div>
//             <label className="text-xs text-gray-400">ENROLLMENT</label>
//             <div className="relative">
//               <input
//                 value={enrollment}
...
//                 className="w-full bg-transparent border-b border-gray-700 py-2 px-2 pr-8 outline-none focus:border-[#ff9a5a]"
//               />
//               <Building2 className="absolute right-2 top-2 w-5 h-5 text-gray-500" />
//             </div>
//           </div>
...
//                 className="w-full bg-transparent border-b border-gray-700 py-2 px-2 pr-8 outline-none focus:border-[#ff9a5a]"
//               />
//               <Lock className="absolute right-2 top-2 w-5 h-5 text-gray-500" />
//             </div>
//           </div>
...
//             type="submit"
//             disabled={loading}
//             className="w-full py-2 rounded-full bg-gradient-to-r from-[#ff7a2a] to-[#ffb84d] text-black font-semibold shadow-sm hover:opacity-95 transition disabled:opacity-60"
//           >
//             {loading ? (
//               <>
