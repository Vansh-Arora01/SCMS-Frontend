      ...
      >
        ...
        {isMainDashboard && !loading && (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-slate-900/60 border border-slate-700 rounded-2xl p-4 md:p-6 backdrop-blur-xl">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-2xl p-4 md:p-6">
        ...
        {isMainDashboard && !loading && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div
              ...
              className="bg-slate-900/60 border border-slate-700 rounded-2xl p-4 md:p-6 backdrop-blur-xl hover:border-blue-500/40 transition cursor-pointer"
            >
            ...
            <div className="bg-slate-900/60 border border-slate-700 rounded-2xl p-4 md:p-6 backdrop-blur-xl hover:border-indigo-500/40 transition cursor-pointer">
              <h3 className="text-base md:text-lg font-semibold mb-2">
                Monitor Performance
              </h3>
