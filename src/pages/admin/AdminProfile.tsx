...
const AdminProfile = () => {
  ...
  const { getProfile } = useAdminService();
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl mx-auto bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg"
    >
